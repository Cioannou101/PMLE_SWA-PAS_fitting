...
This script contains functions for loading SPICE kernels, computing the radial distance of Solar Orbiter from the Sun, and aligning it with the PAS time grid.
"""
